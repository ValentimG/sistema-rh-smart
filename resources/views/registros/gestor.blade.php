...
<header class="hd">
  <div class="logo">
    ...
    <div><div class="logo-n">SMART RH</div><div class="logo-s">PAINEL DO GESTOR</div></div>
  </div>
  <div class="hd-r">
    <nav class="nav">
      <a href="{{ route('gestor.dashboard') }}" class="nl on">
      ...
      <a href="{{ route('funcionarios.index') }}" class="nl">
        <svg viewBox="0 0 24 24"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>Funcionários
      </a>
    ...
    <a href="{{ route('gestor.exportar-csv') }}" class="csv-btn">
    ...
    <span style="font-size:.82rem;font-weight:500;color:#374151">{{ Auth::user()->name }}</span>
